...
package com.github.shannah.catsapp;
 ...
 * @author Shai Almog
 */
public class CatsAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Cats App";
    private static final String APP_NAME = "cats-app";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new CatsAppStub());
    }
